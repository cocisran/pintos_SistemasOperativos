...
/* Creates a new kernel thread named NAME with the given initial
    k, which executes FUNCTION passing AUX as the argument,
...
void thread_unblock(struct thread *t)
{
  ...
  if ((t != initial_thread) && (priority < t->priority))
  {
    if (intr_context())
      intr_yield_on_return();
    else
...
/*Funcion de comparacion para la insersion en orden en la lista de procesos listos*/
bool compare_priority(const struct list_elem *e1, const struct list_elem *e2, UNUSED void *aux)
{
